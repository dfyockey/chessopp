 ...
 */
#define YY_SC_TO_UI(c) ((YYLEXPGN_CCHAR) (c))
...
#define YY_END_OF_BUFFERLEXPGN_CCHAR 0
...
#define EOB_ACTLEXPGN_CCONTINUE_SCAN 0
 ...
 */
#define YYLEXPGN_CCURRENT_BUFFER ( (yy_buffer_stack) \
                          ? (yy_buffer_stack)[(yy_buffer_stack_top)] \
                          : NULL)
/* Same as previous macro, but useful when we know that the buffer stack is not
 * NULL or when we need an lvalue. For internal use only.
 */
#define YYLEXPGN_CCURRENT_BUFFER_LVALUE (yy_buffer_stack)[(yy_buffer_stack_top)]
...
#define YY_FLUSH_BUFFER yy_flush_buffer( YYLEXPGN_CCURRENT_BUFFER )
...
#define YY_AT_BOL() (YYLEXPGN_CCURRENT_BUFFER_LVALUE->yy_at_bol)
...
#line 2248 "lex.yylexpgn.cc"

#line 2250 "lex.yylexpgn.cc"
